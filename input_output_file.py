"""
    ...
    2. File I/O(input and output of files):
        hang on to information [long term], writing code that:
            ...
            write to that is [save information];
    ...
    6. open/create => write/read => close/save and close: 
    ...
    7. CLI(command line interface) for file:
        ...
        3): rm c, delete a file named c(empty);
...
for _ in range(3): # range(len), return a list of specific length 
