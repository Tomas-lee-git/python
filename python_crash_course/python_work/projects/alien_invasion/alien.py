"""
    开发计划：
        1. 在屏幕左上角添加一个外星飞船，并指定合适的边距；✅
        2. 沿屏幕上边缘添加一行外星飞船，再不断地添加成行的外星飞船，直到填满屏幕的上半部分；
        3. 让外星飞船向两侧和向下移动，直到外星舰队被全部击落、有外星飞船撞到飞船
            或有外星飞船抵达屏幕的下边缘；
        4. 如果外星舰队都被击落，将再创建一个外星舰队；
        5. 如果有外星飞船撞到飞船或抵达屏幕的下边缘，销毁飞船并再创建一个外星舰队；
...
class Alien(Sprite):
    ...
    def __init__(self, ai_game):
        ...
        # # 每个外星飞船最初都在屏幕的左上角附近，(x, y)代表图像左上角的位置
